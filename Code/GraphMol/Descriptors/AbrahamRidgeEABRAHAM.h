// Auto-generated header for E_abraham Ridge regression model
// Generated from Python scikit-learn Ridge

#ifndef ABRAHAM_RIDGE_EABRAHAM_H
#define ABRAHAM_RIDGE_EABRAHAM_H
...
struct RidgeModel_EABRAHAM {
    static constexpr double intercept = 1.0086631588;
    static constexpr double alpha = 10.0000000000;
...
#endif // ABRAHAM_RIDGE_EABRAHAM_H
