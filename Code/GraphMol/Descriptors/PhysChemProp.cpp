...
#include "physchemprop/viscosity_cascade_exported.h"  // Viscosity cascade model (log10 cP at 25°C)

// Note: v3.3_full cascade model headers are now in PhysChemProp2.cpp
...
std::vector<double> calcPhysChemProp(const ROMol& mol) {
    ...
    // =====================================================================================
    // VISCOSITY - log10(viscosity in cP) at 25°C
    // Features: [osmordred(3585), abraham(9), cascade(12), LSFER(54), physics(10)] = 3670
    // =====================================================================================
